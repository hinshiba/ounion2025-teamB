...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS*/ 10, /*DC=*/ 8, /*RST=*/ 18, /*BUSY=*/ 17)); // Good Display ESP32E6-E01 board
